...
import { isPassenger, isAdmin } from '@/utils/roles'
...
export default function Login() {
  ...
  const onSubmit = async (data: LoginForm) => {
    try {
      ...
      // Accepter PASSENGER et ADMIN, refuser DRIVER
      if (!isPassenger(response.user.roles) && !isAdmin(response.user.roles)) {
        toast.error('Ce compte n\'est pas un compte passager ou administrateur. Veuillez utiliser la connexion conducteur.')
        return
      }
        ...
        <div className="card-gradient border-2 border-primary-200">
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800">Espace Passager</h3>
            </div>
