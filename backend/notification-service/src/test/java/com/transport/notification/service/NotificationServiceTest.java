...
class NotificationServiceTest {
    ...
    void testSendNotification_Success() {
        ...
        // One save on creation + two saves during channel sending
    ...
    void testSendNotification_WithTemplate() {
        ...
        // Template is processed for both subject and body
        verify(templateProcessor, times(2)).processTemplate(anyString(), anyMap());
    }
